...
const TopBrands = () => {
  return (
    <div className='h-full w-full '>
      <div className='border-l-4 border-amber-500 pl-3 mb-6'>
        <h2 className='text-xl sm:text-2xl font-bold text-teal-950'>Top Brands</h2>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4'>
        {brands.map((brand, idx) => (
          ...
          >
            <span className={`text-3xl sm:text-3xl ${brand.text}`}>{brand.icon}</span>
